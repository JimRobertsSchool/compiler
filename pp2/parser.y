...
%token   <nullConstant> T_NullConstant
...
%type <expr>      OptExpr Expr Constant
%type <exprList>  ExprList Actuals
%type <stmtList>  StmtList
%type <lValue>    LValue
%type <call>      Call
%type <stmt>      StmtBlock Stmt
%type <cStmt>     IfThenStmt IfElseStmt IfStmt
%type <lStmt>     WhileStmt ForStmt
%type <rStmt>     ReturnStmt
%type <bStmt>     BreakStmt
%type <pStmt>     PrintStmt 
%type <cDecl>     ClassDecl
%type <iDecl>     InterfaceDecl
%type <impList>   ImplementList  ImplementOpt
%type <extend>    ExtendOption 
/*
%type <integerConstant> IConst
%type <doubleConstant> DConst
%type <boolConstant> BConst
%type <stringConstant> SConst
%type <nullConst> NConst
*/
%%
/* Rules
 * -----
...
ClassDecl :    T_Class T_Identifier ExtendOption ImplementOpt '{' FieldList '}' { $$=new ClassDecl(new Identifier(@2, $2), $3, $4, $6); }
;
/*
...
ExtendOption : T_Extends T_Identifier {$$=new NamedType(new Identifier(@2, $2));}
	     | /* */ {$$=NULL;}

ImplementOpt : T_Implements ImplementList { $$=$2; }
	     | /* */ { $$=new List<NamedType*>; }
;

ImplementList  : ImplementList ',' T_Identifier {($$=$1)->Append(new NamedType(new Identifier(@3, $3)));}
...
/*
Prototype : FnHeader ';' { $$=new FnDecl(new Identifier(@2, $2)); }
;
*/

PrototypeList : PrototypeList FnHeader ';' { ($$=$1)->Append($2); }
	      | /* empty */ { $$=new List<Decl*>; }
;
...
IfThenStmt : T_If '(' Expr ')' Stmt { $$=new IfStmt($3, $5, NULL); } %prec ')'
;
IfElseStmt : T_If '(' Expr ')' Stmt T_Else Stmt { $$=new IfStmt($3, $5, $7); }
;
...
Expr : LValue '=' Expr { $$=new AssignExpr($1, new Operator(@2, "="), $3);  }
     ...
     | Expr T_Inc { $$=new PostfixExpr($1, new Operator(@2, "++")); }
     | Expr T_Dec { $$=new PostfixExpr($1, new Operator(@2, "--")); }
